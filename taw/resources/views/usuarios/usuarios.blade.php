                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                              ...
                              <div class="form-group row">
                                      <label class="col-md-3 form-control-label" for="descripción">Descripción</label>
                                      <div class="col-md-9">
                                          <input type="text" id="descripción" name="descripción" class="form-control" placeholder="Descripción">
                                      </div>
                                  </div>
                            </form>
                        </div>
