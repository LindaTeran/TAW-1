            ...
            <nav class="sidebar-nav">
                <ul class="nav">
                    ...
                    <li class="nav-item nav-dropdown">
                        <a class="nav-link nav-dropdown-toggle" href="/usuarios/"><i class="icon-bag"></i> Usuarios</a>
                        <ul class="nav-dropdown-items">
                            <li class="nav-item">
                                <a class="nav-link" href="#"><i class="icon-bag"></i> Venta</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#"><i class="icon-bag"></i> Ingreso</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item nav-dropdown">
