...
class habitaciones {
  ...
  private $con;
  private $tabla = "habitacion"; //variable tabia inicializada
  ...
  public function agregar( $tipo, $nombre, $precio){
    $sql = "INSERT INTO `$this->tabla` (tipo, nombre, precio) VALUES ('$tipo','$nombre', '$precio')";
  ...
  public function editar($id, $tipo, $nombre, $precio){

    $sql = "UPDATE `$this->tabla` SET tipo='$tipo', nombre='$nombre', precio='$precio' WHERE id=$id";
